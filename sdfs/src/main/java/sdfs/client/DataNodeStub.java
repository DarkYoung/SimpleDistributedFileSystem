...
public class DataNodeStub extends AbstractStub implements IDataNode {
    ...
    @Override
    public byte[] read(UUID fileUuid, int blockNumber, int offset, int size) throws IndexOutOfBoundsException, IllegalStateException, IOException {
    ...
    @Override
    public void write(UUID fileUuid, int blockNumber, int offset, byte[] b) throws IndexOutOfBoundsException, IllegalStateException, IOException {
